...
var logout = function(req, res) {
  req.session = {};
  redirect(res, CLIENT.nexturl_query(req));
};
/**
...
exports.connector = function(conf, options) {
  ...
  CLIENT.serializer = serializer.createSecureSerializer(cconf.crypt_key, cconf.sign_key);
  ...
  return router(function(app) {
    app.get(cconf.process_login_url, CLIENT.auth_process_login);
    app.get(cconf.login_url, login);
    app.get(cconf.logout_url, logout);
  });
};
